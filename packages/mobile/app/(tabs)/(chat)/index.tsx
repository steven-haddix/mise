    ...
    <Screen edges={["top"]}>
      ...
      >
        <AppHeader
          title="Mise"
          rightAction={
            <Button isIconOnly variant="ghost" size="sm" onPress={handleNewChat}>
        ...
        <View
          className="flex-row items-end px-4 pt-3 gap-2.5 bg-background"
        ...
        >
          ...
          />
          <Button isIconOnly onPress={handleSend} isDisabled={!input.trim() || isStreaming}>
            <Send color={tokens.foreground} />
          </Button>
        </View>
      </KeyboardAvoidingView>
